    ...
    <div className="py-8 px-4">
      ...
      <div className="max-w-2xl">
        ...
        <p className="mb-8 text-base text-[var(--foreground)]">
          ...
          <LinkWithTooltip
            text="ai"
            description="TensorFlow, PyTorch, OpenAI API"
          /> —
        ...
        <p className="mb-8 text-base text-[var(--foreground)]">
          ...
          <LinkWithTooltip
            text="NGO activities"
            description="working with underprivileged kids"
            imageUrl="/moments/NGO_Activities.jpg"
          />
          .
        </p>
      ...
      <div className="flex gap-5 mt-8">
        <SocialLink href="https://x.com/KRISHNA14knt" label="X" />
        <SocialLink href="https://github.com/Krishna14K" label="GitHub" />
        <SocialLink href="https://www.linkedin.com/in/krishna14singh" label="LinkedIn"/>
        <SocialLink href="https://hashnode.com/@krishnakant" label="Blog" />
      </div>
    </div>
  );
};
