...
const Moments: React.FC = () => {
  ...
  const polaroids = [
    {
      image: "/moments/PWC.jpg",
      description: "BIG-4 PWC community",
      alt: "PWC community",
    },
    {
      image: "/moments/pwc_team.jpg",
      description: "PwC Team",
      alt: "First Day at PWC",
    },
    {
      image: "/moments/Plantation_drive.jpg",
      description: "Plantation Drive - 2024",
      alt: "Grow Green, Breathe Clean.",
    },
    {
      image: "/moments/wall_painting.jpg",
      description: "Wall Painting Drive - 2024",
      alt: "Nurture Nature, Nurture Lifen.",
    },
    {
      image: "/moments/wall_paint.jpg",
      description: "Paint the Change You Wish to See.",
      alt: "Wall Painting Drive - 2024",
    },
    {
      image: "/moments/diya_painting.jpg",
      description: "Oracle Team❤️",
      alt: "Light Up Lives with Colors of Joy."
    },
    {
      image: "/moments/Diya_in_Process.jpg",
      description: "Bringing Light to Life, One Diya at a Time.",
      alt: "Diwali Diya Painting",
    },
    {
      image: "/moments/Diyas.jpg",
      description: "Paint, Shine, and Celebrate Together.",
      alt: "Diwali Diya Painting",
    },
  ];
